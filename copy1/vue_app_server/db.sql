...
#创建表 xz_Bcomment 评论表
CREATE TABLE xz_Bcomment(
  id INT PRIMARY KEY AUTO_INCREMENT,
  content VARCHAR(2000),
  ctime DATETIME,
  nid   INT
);
INSERT INTO xz_Bcomment VALUES(null,'1',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'2',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'3',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'4',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'5',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'6',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'7',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'8',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'9',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'10',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'11',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'12',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'13',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'14',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'15',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'16',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'17',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'18',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'19',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'20',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'21',now(),1);
INSERT INTO xz_Bcomment VALUES(null,'22',now(),1);
...
#书籍记录
# 书籍信息:id name title author
# 封面:book_url
CREATE TABLE xz_book(
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(25),
  title VARCHAR(128),
  author  VARCHAR(25),
  book_url VARCHAR(128)
);
characterEncoding="utf8";
INSERT INTO xz_book VALUES(null,'绝世兵王','绝世特种兵回归都市','北冥小妖','http://127.0.0.1:3000/img/1.jpg');
INSERT INTO xz_book VALUES(null,'绝世兵王','绝世特种兵回归都市','北冥小妖','http://127.0.0.1:3000/img/1.jpg');
INSERT INTO xz_book VALUES(null,'绝世兵王','绝世特种兵回归都市','北冥小妖','http://127.0.0.1:3000/img/1.jpg');

CREATE TABLE xz_book2(
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(25),
  book_url VARCHAR(128)
)
ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO xz_book2 VALUES
(null,'盲村','http://127.0.0.1:3000/img/2.jpg'),
(null,'盲村','http://127.0.0.1:3000/img/2.jpg'),
(null,'盲村','http://127.0.0.1:3000/img/2.jpg'),
(null,'盲村','http://127.0.0.1:3000/img/2.jpg'),
(null,'盲村','http://127.0.0.1:3000/img/2.jpg'),
